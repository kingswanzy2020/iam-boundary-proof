# Security lead handoff tasks

- [ ] Setup 6: verify Git and AWS CLI
- [ ] Setup 6: save non-root caller output as check 1
- [ ] Setup 6: initialize local Git repository with no remote
...
- [ ] Validation 7: update the self-contained HTML readout
- [ ] Close-out 4: remove boundary and inspect dependencies
- [ ] Close-out 4: delete policy and role
- [ ] Close-out 4: paste two NoSuchEntity results
- [ ] Close-out 4: commit, tag, and confirm no remote